...
// TODO: decide to remove the slide or use it for the robot
...
public class TeleOpDriveOpMode extends OpMode{
    ...
    public void init() {
        ...
        babymode = hardwareMap.get(IMU.class, "IMU");
    ...
    public void loop() {
        ...
        */
        ...
        frontLeft.setPower(fieldCentricBLP);
        frontLeft.setPower(fieldCentricFRP);
        frontLeft.setPower(fieldCentricBRP);
